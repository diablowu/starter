...
/**
 * Validate that the requested java version is compatible with the chosen Spring Boot generation and
 * adapt the request if necessary.
 *
...
public class JavaVersionProjectDescriptionCustomizer implements ProjectDescriptionCustomizer {
  ...
  private static final VersionRange SPRING_BOOT_2_3_0_OR_LATER =
      VersionParser.DEFAULT.parseRange("2.3.0.RELEASE");

  private static final VersionRange SPRING_BOOT_2_4_4_OR_LATER =
      VersionParser.DEFAULT.parseRange("2.4.4");

  private static final VersionRange SPRING_BOOT_2_5_0_OR_LATER =
      VersionParser.DEFAULT.parseRange("2.5.0-RC1");
