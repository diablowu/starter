...
/**
 * {@link BuildCustomizer} for projects containing Spring Cloud Contract Verifier built with Maven.
 *
...
class SpringCloudContractMavenBuildCustomizer implements BuildCustomizer<MavenBuild> {
  ...
  private static final Log logger =
      LogFactory.getLog(SpringCloudContractMavenBuildCustomizer.class);
