...
abstract class SpringIntegrationModuleRegistry {
        ...
        build
            ...
            .add(
                ...
                Dependency.withCoordinates(
                        "org.springframework.integration", "spring-integration-" + id)
                    .scope(scope));
  }
  ...
  private static Consumer<HelpDocument> addReferenceLink(String name, String id) {
    return (helpDocument) -> {
      String href =
          String.format("https://docs.spring.io/spring-integration/reference/html/%s.html", id);
